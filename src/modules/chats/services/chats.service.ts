...
export class ChatsService {
    ...
    async getSystemChat(chatId: string): Promise<DataResponse<ChatEntity | null>> {
        const systemChat = await this.chatsRepository.findOne({ id: chatId, type: ChatTypeEnum.IS_SYSTEM });
